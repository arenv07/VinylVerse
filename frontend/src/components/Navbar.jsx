...
const Navbar = () => {
    return (
        <header>
            ...
            <nav class="mt-2 h-12 bg-brown text-white text-sm lg:text-md xl:text-lg">
                <ul class="flex justify-center items-center h-full w-full gap-4 lg:gap-6 font-poppins">
                    <li>HOME</li>
                    <li>COLLECTION</li>
                    <li>ABOUT</li>
                    <li>CONTACT</li>
